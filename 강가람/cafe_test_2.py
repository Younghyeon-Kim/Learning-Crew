...
Original file is located at
    https://colab.research.google.com/drive/1Xep30qourqaRcu96ptyIsAH0TnSndnnK
"""
...
with open('chatbot_cafe_test_train.pkl', 'rb') as f:
    trainXE, trainXD, trainYD = pickle.load(f)

VOCAB_SIZE = len(idx2word)
EMB_SIZE = 128
LSTM_HIDDEN = 128
MODEL_PATH = 'chatbot_cafetest_trained.h5'
LOAD_MODEL = False
...
# model.save_weights('content/drive/MyDrive/BIGDATA_STUDY/NLP/chatbot/chatbot_trained.h5')
